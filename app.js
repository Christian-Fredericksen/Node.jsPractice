...
const path = require('path')  //<---LIKE BEFORE, we set a var to whatever module. in this case
                              // the 'path' module. like we saw in the os module, if we enter
                // 'path.' here in the text editor we will get a list of this module's built-in
